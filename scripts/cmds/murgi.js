...
module.exports.onStart = async function({ api, event, args }) {
  ...
  if (event.senderID !== OWNER_ID) {
    return api.sendMessage("❌ এই কমান্ডটি শুধুমাত্র মালিক ব্যবহার করতে পারবেন।", event.threadID);
  }

  var mention = Object.keys(event.mentions)[0];
  if(!mention) 
    return api.sendMessage("আপনি কোন ছেলেকে ঠাপাতে চান এমন 1 জনকে @ম্যানশন করতে হবে", event.threadID);
